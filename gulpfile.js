...
gulp.task('icon-font', () => {
  return gulp.src(src_assets_folder + 'icon-font/**/*')
    .pipe(gulp.dest(dist_assets_folder + 'icon-font'))
    .pipe(browserSync.stream());
});

gulp.task('favicon', () => {
  return gulp.src([ src_folder + 'favicon.ico' ], {
    base: src_folder,
...
gulp.task('build', gulp.series('clear', 'html', 'pug', 'sass', 'less', 'stylus', 'js', 'images', 'icon-font', 'favicon', 'vendor'));
